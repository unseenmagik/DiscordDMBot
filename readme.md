...
`/state-clear` clears saved entries from `data/delivery-state.json` without changing the config file. This is useful for testing or for letting a reminder send again.
